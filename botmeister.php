...
* @copyright 2021 STHCoders, Michael Rehnert
* @license GPL-2.0+
*
* @wordpress-plugin
...
Safe This Home, LLC., hereby disclaims all copyright interest in the
program 'Botmeister' (which is used to combat comment spam) written by
Michael Rehnert.

<signed>, 22 August 2021
Edward Schüller, CEO
*/
...
if (class_exists('Botmeister')) {
    ...
    register_activation_hook(__FILE__, ['Botmeister', 'activate']);
    register_deactivation_hook(__FILE__, ['Botmeister', 'deactivate']);
